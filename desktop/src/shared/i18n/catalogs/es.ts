...
export const es: Catalog = {
  ...
  import: {
    ...
    columnTitle: "Conversación",
    columnDate: "Fecha",
    columnChunks: "Elementos estimados",
    selectAllVisible: "Seleccionar todo",
    deselectAllVisible: "Deseleccionar todo",
    fileLabel: "Archivo",
    formatLabel: "Formato",
    selectedCount: {
      one: "{count} de {total} seleccionada",
      other: "{count} de {total} seleccionadas",
    },
