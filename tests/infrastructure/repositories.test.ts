...
import type { ContextItem } from "../../src/domain/entities/context-item.js";
import type { Project } from "../../src/domain/entities/project.js";
import type { ItemType } from "../../src/domain/values/item-type.js";
import type { ProjectName } from "../../src/domain/values/project-name.js";
import type { Tag } from "../../src/domain/values/tag.js";
import { openVaultDb } from "../../src/infrastructure/db/connection.js";
import { SqliteContextItemRepository } from "../../src/infrastructure/db/item-repo.js";
import { migrate } from "../../src/infrastructure/db/migrations.js";
import { SqliteProjectRepository } from "../../src/infrastructure/db/project-repo.js";
